...
#### 1.1.1. Run the base driver:
    ...
    roslaunch pupperv2_description_config bringup.launch rviz:=true
...
#### 1.2.1. Run the Gazebo environment:
    ...
    roslaunch pupperv2_description_config gazebo.launch 

#### 1.2.2. Run gmapping package and move_base:

    roslaunch pupperv2_description_config slam.launch rviz:=true
...
- Save the map by running:
      ...
      roscd pupperv2_description_config/maps
...
#### 1.3.2. Run amcl and move_base:
    ...
    roslaunch pupperv2_description_config navigate.launch rviz:=true
...
Spawning a robot:
    ...
    roslaunch pupperv2_description_config spawn_robot.launch robot_name:=<unique_robot_name> world_init_x:=<x_position> world_init_y:=<y_position>
